...
function PTPS() {
  ...
  const trackInfo = [
    {
      title: "Main Menu",
      track: require("../assets/PTPS/PTPS ST01v1 M01v4 Main Menu.wav"),
      index: "1",
      length: "1:52",
    },
    {
      title: "City Town Level",
      track: require("../assets/PTPS/PTPS ST02v1 M02v2 City Town Level.wav"),
      index: "2",
      length: "2:17",
    },
    {
      title: "Factory Sewer Level",
      track: require("../assets/PTPS/PTPS ST03v1 M03v2 Factory Sewer Level.wav"),
      index: "3",
      length: "2:34",
    },
    {
      title: "Wizard HQ Level",
      track: require("../assets/PTPS/PTPS ST04v1 M04v2 Wizard HQ Level.wav"),
      index: "4",
      length: "2:35",
    },
    {
      title: "Hideout",
      track: require("../assets/PTPS/PTPS ST05v1 M05v2 Hideout.wav"),
      index: "5",
      length: "2:05",
    },
  ];
  ...
  const audioTracks = [
    require("../assets/PTPS/PTPS ST01v1 M01v4 Main Menu.wav"),
    require("../assets/PTPS/PTPS ST02v1 M02v2 City Town Level.wav"),
    require("../assets/PTPS/PTPS ST03v1 M03v2 Factory Sewer Level.wav"),
    require("../assets/PTPS/PTPS ST04v1 M04v2 Wizard HQ Level.wav"),
    require("../assets/PTPS/PTPS ST05v1 M05v2 Hideout.wav"),
  ];
