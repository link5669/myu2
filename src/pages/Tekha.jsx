...
function Tekha() {
  ...
  const trackInfo = [
    {
      title: "Tekha",
      track: require("../assets/Tekha/TEKHA T01 Tekha.wav"),
      index: "1",
      length: "2:49",
    },
    {
      title: "Tekha (Instrumental)",
      track: require("../assets/Tekha/TEKHA T02 Tekha (Instrumental).wav"),
      index: "2",
      length: "2:44",
    }
  ];
  ...
  const audioTracks = [
    ...
    require("../assets/Tekha/TEKHA T02 Tekha (Instrumental).wav"),
  ];
                  ...
                  <Col xl={4}>
                    ...
                    >
                      ...
                      <a
                        ...
                        href="https://www.youtube.com/watch?v=WZYwwtbkHT4&list=PLWLXJaKFBj4LLxc5oMhW_sYLBSPbaDUBP"
                      >
                        {youTubeMouseOver ? (
                          <svg
                      ...
                      <a
                        ...
                        href="https://soundcloud.com/marcyumusic/sets/across-the-astral-sea-tekha"
                      >
                        {soundcloudMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Col style={{ paddingRight: "18%", paddingLeft: "2%" }}>
                    <div style={{ color: "white", fontFamily: "Georgia" }}>
                      ...
                      >
                        ...
                        <li>
                          Sound Designer:{" "}
                          <span style={{ color: "#B9BAB9" }}>Caleb Skelly</span>{" "}
                        </li>
                        <li>
                          Dialogue Mixer:{" "}
                        ...
                        <li>
                          Electric Guitar:{" "}
                          <span style={{ color: "#B9BAB9" }}>Alejandro Espinosa</span>{" "}
                        </li>
                        <li>
                          Electric Guitar:{" "}
                        ...
                        <li>
                          Electric Bass:{" "}
                          <span style={{ color: "#B9BAB9" }}>Adrián Rincón</span>{" "}
                        </li>
                        <li>
                          Drums:{" "}
