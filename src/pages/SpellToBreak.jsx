...
import btrp from "../assets/spell.png";
import "react-h5-audio-player/lib/styles.css";
import track1 from "../assets/spell/ASTB-T01v1 M01 Under A Spell.wav";
...
function SpellToBreak() {
  ...
  const trackInfo = [
    {
      title: "Under A Spell",
      track: require("../assets/spell/ASTB-T01v1 M01 Under A Spell.wav"),
      index: "1",
      length: "2:09",
    },
    {
      title: "It Takes A Village",
      track: require("../assets/spell/ASTB-T02v1 M02 It Takes A Village.wav"),
      index: "2",
      length: "1:13",
    },
    {
      title: "Luna and Sol",
      track: require("../assets/spell/ASTB-T03v1 M03 Luna and Sol.wav"),
      index: "3",
      length: "0:33",
    }
  ];
  ...
  const audioTracks = [
    require("../assets/spell/ASTB-T01v1 M01 Under A Spell.wav"),
    require("../assets/spell/ASTB-T02v1 M02 It Takes A Village.wav"),
    require("../assets/spell/ASTB-T03v1 M03 Luna and Sol.wav"),
  ];
        ...
        <Container>
          <Row>
            <Col style={{ alignContent: "left", paddingLeft: "18%" }}>
              ...
              >
                <i>Short Film / Magical Fantasy</i>
              </p>
              <Container>
                <Row>
                  <Col xl={4}>
                    ...
                    >
                      <a
                        ...
                        href="https://music.apple.com/us/album/a-spell-to-break-original-soundtrack-single/1758017429"
                      >
                        {!appleMouseOver ? (
                      ...
                      <a
                        ...
                        href="https://www.youtube.com/watch?v=JKgVGGI9HTo&list=PLWLXJaKFBj4IZ6FUWu7w7SmIBmHf9q_vS"
                      >
                        {youTubeMouseOver ? (
                          <svg
                      ...
                      <a
                        ...
                        href="https://soundcloud.com/marcyumusic/sets/a-spell-to-break-original-soundtrack-1"
                      >
                        {soundcloudMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a
                        ...
                        href="https://open.spotify.com/album/5BkseWCHr3rMnTbxjfRx64?si=Bdl9KO6ZT4eZMvV3H4NFlA"
                      >
                        {spotifyMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Col style={{ paddingRight: "18%", paddingLeft: "2%" }}>
                    <div style={{ color: "white", fontFamily: "Georgia" }}>
                      ...
                      >
                        ...
                        <li>
                          Woodwinds:{" "}
                          <span style={{ color: "#B9BAB9" }}>Collin Vodicka</span>{" "}
                        </li>
                        <li>
                          Violins:{" "}
                      ...
                      <p style={{ fontSize: "1.1rem", color: "#B9BAB9" }}>
                        A young witch, flooded with summon requests, starts to crumble under the weight of fulfilling them all. Her sprightly companion and the people of her small village help to carry the load, helping her realize that she doesn’t have to go through this alone. <br />
                        <br />
                        Created by Isa Johnson, Dorothy Vu, and Ash Liang
                      </p>
                    </div>
                  </Col>
                </Row>
