...
import dreamFactoryTrack from "../assets/DreamFactory/TDF T01v1 M01 The Dream Factory.wav";
...
function DreamFactory() {
  ...
  const trackInfo = [
    {
      ...
      track: require("../assets/DreamFactory/TDF T01v1 M01 The Dream Factory.wav"),
      index: "1",
      length: "2:10",
    },
    {
      title: "The First Step of Every Journey",
      track: require("../assets/DreamFactory/TDF T02v1 M02 The First Step of Every Journey.wav"),
      index: "2",
      length: "2:16",
    },
  ];
  ...
  const audioTracks = [
    require("../assets/DreamFactory/TDF T01v1 M01 The Dream Factory.wav"),
    require("../assets/DreamFactory/TDF T02v1 M02 The First Step of Every Journey.wav"),
  ];

  const [selectedTrack, setSelectedTrack] = useState({
    title: "The Dream Factory",
    track: dreamFactoryTrack,
    index: "1",
    length: "2:10",
  });
  ...
  const handleHoverLeave = () => {
    setHoveredItem({ title: "", track: dreamFactoryTrack, index: "", length: "" });
  };
                ...
                <Row>
                  <Col xl={4}>
                    ...
                    >
                      <a
                        ...
                        href="https://music.apple.com/us/album/the-dream-factory-original-soundtrack-single/1748444219"
                      >
                        {!appleMouseOver ? (
                      ...
                      <a
                        ...
                        href="https://www.youtube.com/watch?v=P81QJJvPt98&list=PLWLXJaKFBj4L8S97F7Q5zBBIzansFRndo"
                      >
                        {youTubeMouseOver ? (
                          <svg
                      ...
                      <a
                        ...
                        href="https://soundcloud.com/marcyumusic/sets/the-dream-factory-original-soundtrack"
                      >
                        {soundcloudMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a
                        ...
                        href="https://open.spotify.com/album/3B4ySRkGg4SQX5eOHDcBIc?si=5afzkeqVRHSR2c3KBvVYWg"
                      >
                        {spotifyMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Col style={{ paddingRight: "18%", paddingLeft: "2%" }}>
                    <div style={{ color: "white", fontFamily: "Georgia" }}>
                      ...
                      A fledging factory worker finally gets to try their hand at creating dreams. But under the stern eye of their mentor, things start going awry. Eventually, the mentor realizes that in order to make dreams come true, they can’t be crushed at the first mistake.
 <br />
                        <br />
                        Created by Jiyoon Oh and Hyojin Shim
                      </p>
                    </div>
                  </Col>
                </Row>
