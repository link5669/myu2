...
function ROTS() {
    ...
    const trackInfo = [
        {
            ...
            track: require("../assets/ROTS-DELTA M01v2 Delta Emblock's Theme.wav"),
            index: "1",
            length: "2:32",
        }
    ];
    ...
    const audioTracks = [
        require("../assets/ROTS-DELTA M01v2 Delta Emblock's Theme.wav"),
    ];
                                ...
                                <Row>
                                    <Col xl={4}>
                                        ...
                                        >
                                            <a
                                                target="_blank"
                                                href="https://youtu.be/67g59ce1XGM"
                                                style={{ opacity: 0 }}
                                            >
                                                <svg
                                            ...
                                            <a
                                                ...
                                                href="https://soundcloud.com/marcyumusic/delta-emblocks-theme"
                                            >
                                                {soundcloudMouseOver ? (
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <Col style={{ paddingRight: "18%", paddingLeft: "2%" }}>
                                        <div style={{ color: "white", fontFamily: "Georgia" }}>
                                            ...
                                            >
                                                ...
                                                <br />
                                                <li>
                                                    Voice of “Delta Emblock”:{" "}
                                                    <span style={{ color: "#B9BAB9" }}>
                                                        Afaedite (Aaron De Niro)
                                                    </span>{" "}
                                                </li>
                                                <br />
                                                <li>
                                                    Vocals:{" "}
                                                    <span style={{ color: "#B9BAB9" }}>Sam Rindfuss</span>{" "}
                                                </li>
                                                <li>
                                                    Flute:{" "}
                                                ...
                                                <li>
                                                    Violin:{" "}
                                                    <span style={{ color: "#B9BAB9" }}>Miles Acquaviva</span>{" "}
                                                </li>
                                                <li>
                                                    Viola:{" "}
                                                    <span style={{ color: "#B9BAB9" }}>Franco Grimoldi Calo</span>{" "}
                                                </li>
                                                <li>
                                                    Guitar:{" "}
